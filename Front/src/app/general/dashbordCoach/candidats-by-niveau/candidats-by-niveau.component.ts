...
export class CandidatsByNiveauComponent implements OnInit {
  ...
  constructor(private userService: UserService) { 
    ...
    this.userService.getCandidatByNiveau(this.userService.connectedUser.niveau).subscribe(res => {
  ...
  getCandidatByNiveau(niveau){
    this.userService.getCandidatByNiveau(niveau).subscribe((res) => {
      console.log(res)
       this.candidatsByniveau = res;
    })
  }
  ...
  deleteCandidat(candidat) {
    this.userService.deleteCandidat(candidat).subscribe(() => {
      this.getCandidatByNiveau(this.userService.connectedUser._id);
    })
  }
}
